...
app.whenReady().then(() => {
  ...
  const contextMenu = Menu.buildFromTemplate([
    { label: 'help', type: 'normal', click: () => { console.log('hello world!') }},
    { label: '', type: 'separator' },
    { label: 'option 1', type: 'radio' },
    { label: 'option 2', type: 'radio', checked: true },
  ])

  tray.setToolTip('A minimal Electron application with Flask server.')
